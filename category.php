...
<div class="content-header">
    <div class="container-fluid">
        <div class="row mb-2">
			<div class="col-sm-6">
				<h1 class="m-0 text-dark">Category 类别</h1>
			</div><!-- /.col -->
        </div><!-- /.row -->
    </div><!-- /.container-fluid -->
</div>
				...
				<div class="card">
					<div class="card-header">
                        <div class="row">
                            <div class="col-9"></div>
                            <div class="col-3">
                                <button type="button" class="btn btn-block bg-gradient-warning btn-sm" id="addReasons">Add Category 新增类别</button>
                            </div>
                        </div>
                    </div>
					<div class="card-body">
      ...
      <div class="modal-content">
        <form role="form" id="reasonForm">
            <div class="modal-header">
              <h4 class="modal-title">Add Category 新增类别</h4>
            ...
            <div class="modal-body">
                <div class="card-body">
                    ...
                    <div class="form-group">
    					<label for="reasons">Category Name 类别名称 *</label>
...
$(function () {
    ...
    $.validator.setDefaults({
        submitHandler: function () {
            $('#spinnerLoading').show();
            $.post('php/category.php', $('#reasonForm').serialize(), function(data){
...
function edit(id){
    ...
    $.post('php/getCategory.php', {userID: id}, function(data){
        ...
        if(obj.status === 'success'){
            ...
            $('#reasonModal').find('#reasons').val(obj.message.category);
            $('#reasonModal').modal('show');
