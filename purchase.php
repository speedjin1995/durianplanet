...
<div class="content-header">
    <div class="container-fluid">
        <div class="row mb-2">
			<div class="col-sm-6">
				<h1 class="m-0 text-dark">Purchasing 采购</h1>
			</div><!-- /.col -->
        </div><!-- /.row -->
    </div><!-- /.container-fluid -->
</div>
				...
				<div class="card">
					<div class="card-header">
                        <div class="row">
                            ...
                            <div class="col-3">
                                <button type="button" class="btn btn-block bg-gradient-warning btn-sm" id="addGrades">Add Purchase 新增采购</button>
                            </div>
                        </div>
                    </div>
					<div class="card-body">
      ...
      <div class="modal-content">
        <form role="form" id="gradeForm">
            ...
            <div class="modal-body">
                ...
                <input type="hidden" class="form-control" id="lotNo" name="lotNo">

                <div class="row col-12">
                    <button style="margin-left:auto;margin-right: 25px;" type="button" class="btn btn-primary add-row">Add Items 添加产品</button>
                </div><br>
...
<script type="text/html" id="addContents">
    <tr class="details">
        ...
        <td>
            <div class="form-group">
                <input type="number" class="form-control" name="itemPrice" id="itemPrice" step="0.01" placeholder="Enter Item Price">
            </div>
        </td>
        <td>
            <div class="form-group">
